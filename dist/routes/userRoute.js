...
router.put("/change-activate-status", auth_middleware_1.default, permission_controller_1.default.ActivateUser);
router.put("/user-role-update", auth_middleware_1.default, permission_controller_1.default.userRollUpdate);
router.put("/user-app-update", auth_middleware_1.default, permission_controller_1.default.userAppsUpdate);
router.put("/user-email-verify", auth_middleware_1.default, permission_controller_1.default.UserEmailVerify);
router.put("/user-phone-verify", auth_middleware_1.default, permission_controller_1.default.UserPhoneVerify);
router.put("/user-permission-update", auth_middleware_1.default, permission_controller_1.default.userPermissionsUpdate);
